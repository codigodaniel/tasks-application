...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.is_delayed'
        db.add_column('tasks_task', 'is_delayed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.is_delayed'
        db.delete_column('tasks_task', 'is_delayed')
